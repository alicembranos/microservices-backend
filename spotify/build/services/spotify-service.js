        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(data);
                        return [4 /*yield*/, this.repository.getDocumentByFilter(model, data)];
                    case 1:
                        documentResult = _a.sent();
                        return [2 /*return*/, (0, index_1.formateData)(documentResult)];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (0, index_1.formateData)("".concat(type, " does not exist."))];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (0, index_1.formateData)("Playlist does not exist.")];
                }
            });
        });
    };
