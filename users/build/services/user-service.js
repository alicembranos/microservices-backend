...
var UserService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repository.getDocumentByField(index_2.default.User, email)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            return [2 /*return*/, (0, index_1.formateData)(null)];
                        }
                    ...
                    case 3:
                        token = _a.sent();
                        return [2 /*return*/, (0, index_1.formateData)(token)];
                }
            });
        });
    };
    UserService.prototype.signUp = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, username, image, user, hashPassword, newUser, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = data.email, password = data.password, username = data.username, image = data.image;
