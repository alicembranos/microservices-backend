...
class SpotifyService {
    ...
    search(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const documentResult = yield this.repository.getDocumentBySearch(model, data);
    ...
    deleteFromArray(model, id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const document = yield this.repository.getDocumentById(model, id);
            if (document !== undefined) {
                const selectedArrayDocument = document === null || document === void 0 ? void 0 : document.tracks;
                ...
                const documentResult = yield this.repository.deleteFromArrayInDocument(model, id, selectedArrayDocument);
                return (0, index_1.formateData)(documentResult);
            }
