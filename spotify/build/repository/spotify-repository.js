...
class Spotify {
    ...
    getDocumentById(model, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const populateField = (0, index_1.selectFieldsToPopulate)(model);
            return yield model.findById(id).populate(populateField);
        });
    }
    ...
    getDocumentBySearch(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const populateField = (0, index_1.selectFieldsToPopulate)(model);
            const objectData = (0, index_1.convertParamToObject)(model, data);
            if (objectData.title) {
                return yield model
                    .find({
    ...
    deleteFromArrayInDocument(model, id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const populateField = (0, index_1.selectFieldsToPopulate)(model);
            return yield model
