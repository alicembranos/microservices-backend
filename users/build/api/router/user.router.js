...
exports.default = (app, channel) => {
    ...
    app.get("/user/:id", auth_middleware_1.default, (req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { params: { id }, } = req;
            console.log(req);
    ...
    app.patch("/user/:id", auth_middleware_1.default, ({ params: { id }, user: { sub: userId }, body }, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
        var _b;
        if (id !== userId)
            return res.status(401).json({ ok: true, msg: "Not authorized" });
        if (!((_b = body.image) === null || _b === void 0 ? void 0 : _b.includes("res.cloudinary.com"))) {
            const secureUrlCloudinary = yield (0, cloudinary_1.default)(body.image);
